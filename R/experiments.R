...
# Simulated data
run_experiments(data_path = "../data/rerun2/",
                 results_path = "../results-new/public2.csv",
                 random_split = TRUE,
                 method = c("annealscore"),
                 a = -10, b = 10)
run_experiments(data_path = "../data/rerun/",
                results_path = "../results-new/sim5.csv",
                random_split = FALSE,
                method = c("annealscore", "annealscore-cv"),
                a = -5, b = 5)
run_experiments(data_path = "../data/rerun/",
                results_path = "../results-new/sim3.csv",
                random_split = FALSE,
                method = c("annealscore", "annealscore-cv"),
                a = -3, b = 3)
